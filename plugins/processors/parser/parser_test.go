...
func compareMetrics(t *testing.T, expected, actual []opsagent.Metric) {
...
func getMetricFields(metric opsagent.Metric) interface{} {
	key := "field3"
...
func getMetricFieldList(metric opsagent.Metric) interface{} {
	key := "field3"
