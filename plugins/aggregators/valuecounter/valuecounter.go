...
func NewValueCounter() opsagent.Aggregator {
	vc := &ValueCounter{}
	vc.Reset()
	return vc
}
...
func (vc *ValueCounter) Add(in opsagent.Metric) {
	id := in.HashID()
...
func (vc *ValueCounter) Push(acc opsagent.Accumulator) {
...
func init() {
	aggregators.Add("valuecounter", func() opsagent.Aggregator {
