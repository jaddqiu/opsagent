	...
	}{
		{
			...
			metrics: &Metrics{
				Datapoints: []DataPoint{
					{
						...
						Tags: map[string]string{
							...
							"executor_id":   "opsagent.192fb45f-cc0c-11e7-af48-ea183c0b541a",
							"executor_name": "Command Executor (Task: opsagent.192fb45f-cc0c-11e7-af48-ea183c0b541a) (Command: NO EXECUTABLE)",
							"framework_id":  "ab2f3a8b-06db-4e8c-95b6-fb1940874a30-0001",
							"source":        "opsagent.192fb45f-cc0c-11e7-af48-ea183c0b541a",
						},
						Unit:  "count",
						Value: 42.0,
					},
				...
				Dimensions: map[string]interface{}{
					...
					"mesos_id":  "2dfbbd28-29d2-411d-92c4-e2f84c38688e-S1",
					"task_id":   "opsagent.192fb45f-cc0c-11e7-af48-ea183c0b541a",
					"task_name": "opsagent",
				},
			},
			check: func(acc *testutil.Accumulator) []bool {
