...
func (r *Raindrops) Gather(acc opsagent.Accumulator) error {
...
func (r *Raindrops) gatherUrl(addr *url.URL, acc opsagent.Accumulator) error {
...
func init() {
	inputs.Add("raindrops", func() opsagent.Input {
