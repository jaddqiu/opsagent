...
// by a Jolokia agent.
func (g *Gatherer) Gather(client *Client, acc opsagent.Accumulator) error {
...
func (g *Gatherer) gatherResponses(responses []ReadResponse, tags map[string]string, acc opsagent.Accumulator) {
