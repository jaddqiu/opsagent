...
func (s CommitCommentEvent) NewMetric() opsagent.Metric {
...
func (s CreateEvent) NewMetric() opsagent.Metric {
	event := "create"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeleteEvent) NewMetric() opsagent.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeploymentEvent) NewMetric() opsagent.Metric {
	event := "deployment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeploymentStatusEvent) NewMetric() opsagent.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s ForkEvent) NewMetric() opsagent.Metric {
	event := "fork"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s GollumEvent) NewMetric() opsagent.Metric {
	event := "gollum"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s IssueCommentEvent) NewMetric() opsagent.Metric {
	event := "issue_comment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s IssuesEvent) NewMetric() opsagent.Metric {
	event := "issue"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s MemberEvent) NewMetric() opsagent.Metric {
	event := "member"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s MembershipEvent) NewMetric() opsagent.Metric {
	event := "membership"
	t := map[string]string{
		"event":  event,
		"user":   s.Sender.User,
...
func (s PageBuildEvent) NewMetric() opsagent.Metric {
	event := "page_build"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s PublicEvent) NewMetric() opsagent.Metric {
	event := "public"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s PullRequestEvent) NewMetric() opsagent.Metric {
	event := "pull_request"
	t := map[string]string{
		"event":      event,
		"action":     s.Action,
...
func (s PullRequestReviewCommentEvent) NewMetric() opsagent.Metric {
...
func (s PushEvent) NewMetric() opsagent.Metric {
	event := "push"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s ReleaseEvent) NewMetric() opsagent.Metric {
	event := "release"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s RepositoryEvent) NewMetric() opsagent.Metric {
	event := "repository"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s StatusEvent) NewMetric() opsagent.Metric {
	event := "status"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s TeamAddEvent) NewMetric() opsagent.Metric {
	event := "team_add"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s WatchEvent) NewMetric() opsagent.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
