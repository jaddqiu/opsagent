...
func (s *Interrupts) Gather(acc opsagent.Accumulator) error {
...
func reportMetrics(measurement string, irqs []IRQ, acc opsagent.Accumulator, cpusAsTags bool) {
...
func init() {
	inputs.Add("interrupts", func() opsagent.Input {
		return &Interrupts{}
	})
}
