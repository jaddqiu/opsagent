...
func (p *Powerdns) Gather(acc opsagent.Accumulator) error {
...
func (p *Powerdns) gatherServer(address string, acc opsagent.Accumulator) error {
...
func init() {
	inputs.Add("powerdns", func() opsagent.Input {
		return &Powerdns{}
	})
}
