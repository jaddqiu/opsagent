...
func (pa *PuppetAgent) Gather(acc opsagent.Accumulator) error {
...
func structPrinter(s *State, acc opsagent.Accumulator, tags map[string]string) {
...
func init() {
	inputs.Add("puppetagent", func() opsagent.Input {
		return &PuppetAgent{}
	})
}
