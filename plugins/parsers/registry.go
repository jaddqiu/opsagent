...
import (
	...
	"github.com/jaddqiu/opsagent/plugins/parsers/collectd"
	"github.com/jaddqiu/opsagent/plugins/parsers/csv"
	"github.com/jaddqiu/opsagent/plugins/parsers/dropwizard"
	"github.com/jaddqiu/opsagent/plugins/parsers/graphite"
	"github.com/jaddqiu/opsagent/plugins/parsers/grok"
	"github.com/jaddqiu/opsagent/plugins/parsers/influx"
	"github.com/jaddqiu/opsagent/plugins/parsers/json"
	"github.com/jaddqiu/opsagent/plugins/parsers/logfmt"
	"github.com/jaddqiu/opsagent/plugins/parsers/nagios"
	"github.com/jaddqiu/opsagent/plugins/parsers/value"
	"github.com/jaddqiu/opsagent/plugins/parsers/wavefront"
)
...
type Parser interface {
	...
	// and parses it into opsagent metrics
	//
	// Must be thread-safe.
	Parse(buf []byte) ([]opsagent.Metric, error)

	// ParseLine takes a single string metric
	// ie, "cpu.usage.idle 90"
	// and parses it into a opsagent metric.
	//
	// Must be thread-safe.
	ParseLine(line string) (opsagent.Metric, error)
