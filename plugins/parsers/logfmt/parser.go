...
func (p *Parser) Parse(b []byte) ([]opsagent.Metric, error) {
...
func (p *Parser) ParseLine(s string) (opsagent.Metric, error) {
...
func (p *Parser) applyDefaultTags(metrics []opsagent.Metric) {
