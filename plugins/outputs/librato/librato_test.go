...
var (
	...
	fakeUser  = "opsagent@influxdb.com"
	fakeToken = "123456"
)
...
func TestUriOverride(t *testing.T) {
	...
	l := NewLibrato(ts.URL)
	l.APIUser = "opsagent@influxdb.com"
	l.APIToken = "123456"
	err := l.Connect()
	require.NoError(t, err)
	err = l.Write([]opsagent.Metric{newHostMetric(int32(0), "name", "host")})
	require.NoError(t, err)
}
...
func newHostMetric(value interface{}, name, host string) opsagent.Metric {
	m, _ := metric.New(
		name,
